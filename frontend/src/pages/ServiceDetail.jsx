        ...
        <div className="rush-container">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            ...
            <div className="lg:col-span-7">
              ...
              <h1 className="text-3xl sm:text-5xl md:text-6xl font-black uppercase tracking-tight text-black leading-[1.05] mb-3 font-['Sansation']">
        ...
        <div className="rush-container">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-14">
            <div>
              ...
              <h2 className="text-3xl sm:text-5xl font-black uppercase tracking-tight text-black font-['Sansation']">
                {service.itemsTitle}
              </h2>
            </div>
            ...
            {service.items.map((item, idx) => (
              ...
              >
                <div>
                  ...
                  <h3 className="text-xl font-black text-black font-['Sansation'] tracking-tight mb-2.5 group-hover:text-[#12b7d4] transition-colors">
                    {item.title}
                  </h3>
      ...
      <ScrollSection className="py-20 lg:py-24 border-b border-[#eaeaea] bg-[#fafafa]">
        <div className="rush-container">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl sm:text-5xl font-black uppercase tracking-tight text-black font-['Sansation'] mb-4">
            ...
            {service.processSteps.map((step, idx) => (
              ...
              >
                <div>
                  ...
                  <h3 className="text-2xl font-black uppercase tracking-tight text-black font-['Sansation'] mb-2">
                    {step}
                  </h3>
        ...
        <div className="rush-container">
          <div className="bg-black text-white rounded-3xl sm:rounded-[36px] p-8 sm:p-14 lg:p-16 relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10 max-w-3xl">
              ...
              <h2 className="text-3xl sm:text-5xl lg:text-6xl font-black uppercase tracking-tight text-white font-['Sansation'] leading-[1.05] mb-6">
                {service.ctaText}
              </h2>
        ...
        <div className="rush-container">
          <div className="flex items-center justify-between gap-4 mb-10">
            <div>
              ...
              <h3 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-black font-['Sansation']">
            ...
            {otherServices.map((other) => (
              ...
              >
                <div>
                  ...
                  <h4 className="text-lg sm:text-xl font-black uppercase tracking-tight text-black mb-2 font-['Sansation']">
