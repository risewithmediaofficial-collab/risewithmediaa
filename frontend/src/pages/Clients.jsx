...
const saasProducts = [
  {
    ...
    tagline: "Operations, client pipeline, and agency automation suite",
    description: "Cloud-native operating system built for fast-scaling agencies and brands. Streamlines lead acquisition, WhatsApp follow-ups, team quotas, and automated client billing.",
    url: "https://company.risewithmedia.com",
    domain: "company.risewithmedia.com",
    highlights: ["Client Operations", "Pipeline Automation", "Staff Roles", "Automated Billing"],
